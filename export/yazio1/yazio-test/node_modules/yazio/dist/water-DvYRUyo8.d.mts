import { T as Token } from './auth-BtDcQtvk.mjs';
import { z } from 'zod';
...
declare const GetUserConsumedItemsOptionsSchema: z.ZodObject<{
    date: z.ZodOptional<z.ZodUnion<[z.ZodDate, z.ZodString]>>;
}, "strip", z.ZodTypeAny, {
...
declare const AddUserConsumedItemsOptionsSchema: z.ZodUnion<[z.ZodObject<{
    id: z.ZodString;
    product_id: z.ZodString;
...
type AddUserConsumedItemsOptions = z.infer<typeof AddUserConsumedItemsOptionsSchema>;
/**
 ...
 */
declare const addUserConsumedItem: (token: Token, entry: AddUserConsumedItemsOptions) => Promise<void>;
/**
 ...
 */
declare const removeUserConsumedItem: (token: Token, entry: AddUserConsumedItemsOptions["id"]) => Promise<void>;
...
export { getUserWeight as a, getUserSuggestedProducts as b, getUserExercises as c, getUserGoals as d, getUserWaterIntake as e, getUserDailySummary as f, getProduct as g, getUserConsumedItems as h, addUserConsumedItem as i, removeUserConsumedItem as r, searchProducts as s };
